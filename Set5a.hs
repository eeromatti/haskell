...
data Person = PersonEntry Int String 
  deriving Show

-- fred is a person whose name is Fred and age is 90
fred :: Person
fred = PersonEntry 90 "Fred"

-- getName returns the name of the person
getName :: Person -> String
getName (PersonEntry _ name) = name
...
setName name (PersonEntry age _) = PersonEntry age name

-- setAge does likewise for age
setAge :: Int -> Person -> Person
setAge age (PersonEntry _ name)  = PersonEntry age name
...
data Position = PositionEntry Int Int
...
getX :: Position -> Int
getX (PositionEntry x _) = x

-- getY returns the y of a position
getY :: Position -> Int
getY (PositionEntry _ y) = y

-- up increases the y value of a position by one
up :: Position -> Position
up (PositionEntry x y) = PositionEntry x (y + 1)
